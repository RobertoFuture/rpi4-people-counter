...
#texto del contador (caracteristicas)
texto = "UP:    DOWN: "
posicion = (7, 25)
...
while True:
    ...
    cv2.putText(frame, texto, posicion, font, size, color, grosor)
    cv2.line(frame,(0,90),(480,90),(3,0,227),2)
